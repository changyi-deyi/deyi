...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , imagePathFormat: "upload/image/{yyyy}{mm}{dd}/{time}{rand:6}"             //图片上传提交地址
        , imageUrlPrefix: "/ueditor/net/"
        ...
        , toolbars: [[
            ...
            'rowspacingtop', 'rowspacingbottom', 'lineheight', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|', 'simpleupload',  '|','justifyleft', 'justifyright', //居右对齐
        ...
        ,'fontfamily':[
            ...
            { label:'',name:'Grill sans',val:'Grill sans'}
        ]
